...
<div class="list-item">
  ...
  <script>
    ...
    // ১. ব্যাকএন্ড থেকে অ্যাপয়েন্টমেন্ট রিকোয়েস্ট লোড করা (Fetch API)
    async function fetchAppointmentRequests() {
        try {
            ...
            if (data.success) {
                ...
                const confirmedCountElem = document.getElementById('upcoming-count');
                if (confirmedCountElem) {
                    confirmedCountElem.textContent = confirmedCount;
                }
    ...
    // ২. রিকোয়েস্ট HTML-এ রেন্ডার করা
        ...
        if (requestsData.length === 0) {
            container.innerHTML = `
                <div class="empty-state">
                    <i class="fa-solid fa-circle-check" style="font-size:32px; color: var(--success-green); margin-bottom:10px;"></i>
                    <p>All appointment requests have been addressed!</p>
                </div>`;
            return;
        }
    ...
    // ৩. রিকোয়েস্ট ডিলিট/ডিক্লাইন করা (Fetch API)
    ...
    // ৪. রিকোয়েস্ট অ্যাকসেপ্ট করা (Fetch API)
    ...
    // পেজ লোড হলে ব্যাকএন্ড থেকে ডেটা কল হবে
